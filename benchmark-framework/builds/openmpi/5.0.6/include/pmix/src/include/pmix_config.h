...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/home/sumeet/benchmark-framework/builds/openmpi/5.0.6\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--with-libevent\' \'--disable-libevent-lib-checks\' \'--with-libevent-extra-libs=/tmp/openmpi-build/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/libevent_core.la /tmp/openmpi-build/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/libevent_pthreads.la\' \'--with-wrapper-libs=-levent_core -levent_pthreads\' \'CPPFLAGS=-I/tmp/openmpi-build/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi -I/tmp/openmpi-build/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/include\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Sun Mar  8 17:06:40 UTC 2026"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "LAPTOP-04N89MSC"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "sumeet"
...
#define PMIX_PACKAGE_STRING "PMIx sumeet@LAPTOP-04N89MSC Distribution"
